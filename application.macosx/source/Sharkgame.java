...
class Shark{
  ...
  public void display(){
    if(alive){
      ...
      image(shark, x, y, w, h);
      fill(256,0,0); // red
      ellipse(x+30, y+60, w*0.5f, w*0.5f); // Draw the target with the properties passed as argument.
      fill(255);
      ellipse(x+30, y+60, w*0.3f, w*0.3f);    
      fill(256,0,0);
      ellipse(x+30, y+60, w*0.1f, w*0.1f);
    }else{
...
public void mousePressed() {
  ...
  public void settings() {  size(596,842);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Sharkgame" };
    if (passedArgs != null) {
